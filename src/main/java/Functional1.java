...
public class Functional1 {
    ...
    /*
     * Statement :: Given a list of integers, return a list where each integer is
     * multiplied by 2.
     */
    ...
    /*
     * Statement :: Given a list of strings, return a list where each string has "*"
     * added at its end.
     */
    ...
    /*
     * Statement :: Given a list of strings, return a list where each string is
    ...
    /*
     * Statement :: Given a list of non-negative integers, return an integer list of
    ...
    /*
     * Statement :: Given a list of strings, return a list where each string has all
     * its "x" removed.
     */
